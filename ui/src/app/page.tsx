...
import { Account, AuthMe, BillingMe } from "@/types";
  ...
  return (
    <main>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href={authenticated ? "/scans" : "/signin"}
                className="rounded-2xl bg-emerald-500 px-6 py-3 font-semibold text-black hover:bg-emerald-400 transition-colors"
              >
                {authenticated ? "Go to Workspace" : "Get Started"}
              </Link>
              <Link
                href="/plans"
      ...
      <section className="py-16">
        ...
        <footer className="mt-16 flex flex-col gap-4 border-t border-white/10 pt-6 text-sm text-neutral-500 md:flex-row md:items-center md:justify-between">
          <div>VigiliCloud</div>
